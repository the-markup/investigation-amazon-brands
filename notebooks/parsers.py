...
def parse_product_listing(product, fn, search_term, product_order, 
    ...
    sponsored_metadata = product.xpath('boolean(.//div[@data-component-type="sp-sponsored-result"])')
    row = {
        "asin": asin,
        ...
        "has_sponsored_metadata": sponsored_metadata,
...
def parse_product_page(fn):
    ...
    third_party = dom.xpath(
        'boolean(.//span[@data-action="show-all-offers-display"] or .//span[@id="mbc-title"])'
    )
    by_amazon = dom.xpath(
